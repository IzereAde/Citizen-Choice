...
<div class="page-wrapper" id="main-wrapper">
  <div class="d-flex align-items-center justify-content-center min-vh-100">
    <div class="col-md-8 col-lg-5">
      <div class="card">
        <div class="card-body">
          <h4 class="text-center">Citizen Complaints or feedback <br> submission</h4>
        ...
        <textarea name="Description" id="" class="form-control" name="citizen_phone_number" required></textarea>
            </div>
